...
const ProfileCard = () => {
    return (
        <>
            <div className="w-full h-auto bg-dirty-white rounded-2xl mb-6 shadow-md">
                <div className="flex justify-center items-center py-10">
                    <div className="flex justify-center items-center h-36 w-36 drop-shadow">
                ...
                <div className="border-t border-input-grey text-base">
                    <button className="w-1/3 p-4 border-r border-input-grey rounded-bl-2xl">
                        <div className="flex flex-col justify-center items-center">
                            <div className="text-3xl text-black pb-1">
                                <PiDogFill />
                            </div>
                            Calendar
                        </div>
